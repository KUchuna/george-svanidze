...
export default function ProjectTeam({projectId}: {projectId: number}) {
    ...
    return (
        <div className="max-w-[30%]">
            ...
            {
                project?.type &&
                <div className="mb-4 dark:text-[#878392] text-[#3F3F3F] text-[12px] lg:text-2xl"><strong>Project type:</strong> {project?.type}</div>
            }
            <div className="dark:text-[#878392] text-[#3F3F3F]  text-[12px] lg:text-2xl"><strong>Designers:</strong> {project?.designers?.map((designer, index) => {
                return (
