        ...
        <footer className="bg-black dark:bg-[#232323] pt-[10.625rem] pb-[13.75rem] px-8 flex justify-between mt-auto font-grotesk">
             ...
             <div className="flex flex-col items-end gap-6">
                <div className="flex gap-3">
                    <a className="h-[128px] w-[128px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://ge.linkedin.com/" target="#">
                    ...
                    <a className="h-[128px] w-[128px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://dribbble.com/" target="##">
