...
export default function Footer() {
    ...
    return (
        <footer className="bg-black dark:bg-[#232323] md:pt-[105px] md:px-8 md:pb-[140px] 2xl:pt-[10.625rem] 2xl:pb-[13.75rem] 2xl:px-8 pt-[74px] pb-10 px-1 flex lg:flex-row flex-col justify-between mt-auto font-grotesk gap-[74px] lg:gap-0">
             <div className="flex lg:gap-8 gap-4 w-full">
                <Image src="/pictures/giorgi.jpeg" alt="Giorgi Svanidze" width={500} height={500} className="lg:rounded-3xl rounded-2xl object-cover 
                lg:max-w-[120px] lg:max-h-[120px] lg:min-w-[120px] lg:min-h-[120px]
                2xl:max-w-[246px] 2xl:max-h-[246px] 2xl:min-w-[246px] 2xl:min-h-[246px] 
                max-w-[72px] max-h-[72px] min-w-[72px] min-h-[72px] 
                w-full h-full select-none" 
                quality={100}
                />
                <div className="h-full flex 2xl:justify-between flex-col font-medium text-gray-2 lg:text-4xl 2xl:text-[4rem] text-xl w-full 2xl:leading-none">
             ...
             <div className="flex lg:flex-col flex-col-reverse items-end gap-6">
                <div className="flex gap-3">
                    <a className="2xl:h-[128px] 2xl:w-[128px] h-[64px] w-[64px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://www.linkedin.com/in/giorgi-svanidze-b3b1091a2/" target="#">
                        <svg viewBox="0 0 92 92" className="w-[46px] h-[46px] 2xl:w-[92px] 2xl:h-[92px] fill-current dark:text-white"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="2xl:h-[128px] 2xl:w-[128px] h-[64px] w-[64px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://dribbble.com/GeorgeSvanidze" target="##">
                        <svg viewBox="0 0 56 57" className="w-[28px] h-[28px] 2xl:w-[56px] 2xl:h-[56px] fill-current dark:text-white" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="2xl:text-5xl lg:text-2xl text-xl w-max text-white">Tbilisi, Georgia</span>
             </div>
        </footer>
    )
}