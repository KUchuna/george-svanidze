    ...
    return (
        <footer className="bg-black dark:bg-[#232323] pt-[10.625rem] pb-[13.75rem] px-8 flex justify-between mt-auto font-grotesk">
             <div className="flex gap-8 w-full">
                <Image src="/pictures/giorgi.jpeg" alt="Giorgi Svanidze" width={246} height={246} className="rounded-3xl object-cover max-w-[246px] max-h-[246px] min-w-[246px] min-h-[246px] w-full h-full select-none" unoptimized/>
             ...
             <div className="flex flex-col items-end gap-6">
                <div className="flex gap-3">
                    <a className="h-[128px] w-[128px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://www.linkedin.com/in/giorgi-svanidze-b3b1091a2/" target="#">
                        <svg width="92" height="92" viewBox="0 0 92 92" className="fill-current dark:text-white"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="h-[128px] w-[128px] bg-gray-2 dark:bg-black flex justify-center items-center rounded-2xl" href="https://dribbble.com/GeorgeSvanidze" target="##">
                        <svg width="56" height="57" viewBox="0 0 56 57" className="fill-current dark:text-white" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-5xl w-max text-white">Tbilisi, Georgia</span>
             </div>
        </footer>
    )
}